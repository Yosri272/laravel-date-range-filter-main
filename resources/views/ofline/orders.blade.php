                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="col-md-5">
                                        <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Customer Location') }}</label>
                                            ...
                                            <input id="customer_location" type="text" class="form-control @error('customer_location') is-invalid @enderror" name="customer_location" value="{{ old('customer_location') }}" required autocomplete="customer_location" autofocus>
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="col-md-5">
                                                    <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Delevery Fees') }}</label>
                                                        ...
                                                        <input id="delevery_fees" type="text" class="form-control @error('delevery_fees') is-invalid @enderror" name="delevery_fees" value="{{ old('delevery_fees') }}" required autocomplete="delevery_fees" autofocus>
